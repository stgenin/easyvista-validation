node() {
    ...
    stage ('Import Scenarios from XRay') {
        step([$class: 'XrayExportBuilder', credentialId: '', filePath: 'src/test/resources/com/mycompany/app', issues: 'MXP-52', serverInstance: 'SERVER-0ee72acd-5079-404f-8b3e-c3eb0827002a'])
    }
